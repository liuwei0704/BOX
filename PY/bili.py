...
class Spider(Spider):  # 元类 默认的元类 type
	...
	def homeContent(self, filter):
		...
		if not 'class' in result or result['class'] == []:
			result['class'] = [{"type_name":"動態漫","type_id":"動態漫"},{"type_name":"沙雕动画","type_id":"沙雕动画"},{"type_name":"同人•手書","type_id":"同人•手書"},{"type_name":"動漫雜談","type_id":"動漫雜談"},{"type_name":"电影","type_id":"电影"},{"type_name":"电视剧","type_id":"电视剧"}]
		return result

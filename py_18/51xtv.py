...
class Spider(BaseSpider):
    ...
    def _fetch_classes(self):
        ...
        try:
            ...
            # 匹配分类卡片: <a href="/xxx" class="group relative...">...<div>英文标签</div>...<div>中文名称</div></a>
    ...
    def playerContent(self, flag, id, vipFlags=""):
        ...
        if item and item.get("play_url"):
            return {"parse": 0, "url": item["play_url"], "header": {"Referer": self.host + "/", "User-Agent": self.headers["User-Agent"]}}

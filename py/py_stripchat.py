...
class Spider(Spider):
    ...
    def detailContent(self, array):
        ...
        try:
            ...
            return {'list': [{"vod_id": uid, "vod_name": str(info['topic'])[:80], "vod_pic": str(user['avatarUrl']), "vod_director": director_link, "vod_remarks": remark, 'vod_play_from': 'LemonCams', 'vod_play_url': f"{uid}${uid}$$${uid}$lemon_{uid}"}]}
        except: return {'list': []}

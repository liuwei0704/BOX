...
class Spider(E):
	...
	def get_play_url(C,params):
		...
		G=bytearray([104,116,116,112,115,58,47,47,115,109,116,46,100,111,117,98,101,46,101,117,46,111,114,103]).decode();H=G+f"/{B}/playlist.m3u8";D=str(int(time.time()/150));I={'tid':'mc42afe745533','ct':D,'tsum':F.md5(f"tvata nginx auth module/{B}/playlist.m3u8mc42afe745533{D}".encode(A)).hexdigest()};E=H+'?'+parse.urlencode(I);C.cache[B]=E;return E
